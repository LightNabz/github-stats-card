...
function chibiPlaceholder(x, flipX = false) {
  ...
  return `
    <g transform="${transform}" opacity="0.85">
      <image href="https://raw.githubusercontent.com/LightNabz/github-stats-card/main/public/padoru.gif" width="44" height="52" preserveAspectRatio="xMidYMax meet"/>
    </g>
  `;
}
